...
public enum ModArmorTier implements ArmorMaterial {
    ...
    private ModArmorTier(String p_40474_, int p_40475_, int[] p_40476_, int p_40477_, SoundEvent p_40478_, float p_40479_, float p_40480_, Supplier<Ingredient> p_40481_) {
        this.name = p_40474_;
    ...
    public String getName() {
        return Util_Kreperie.MOD_ID+":"+this.name;
    }
