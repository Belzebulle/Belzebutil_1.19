...
public class ModMenuTypes {
    public static final DeferredRegister<MenuType<?>> MENUS =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, fr.krepe.belzebutil.Belzebutil.MOD_ID);

    public static final RegistryObject<MenuType<LeadStationMenu>> LEAD_STATION_MENU =
            registerMenuType(LeadStationMenu::new, "lead_station_menu");
