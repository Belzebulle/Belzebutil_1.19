...
public class EnergyBlockScreen extends AbstractContainerScreen<EnergyBlockMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(fr.krepe.belzebutil.Belzebutil.MOD_ID, "textures/gui/energy_generator_gui.png");
    ...
    public EnergyBlockScreen(EnergyBlockMenu p_97741_, Inventory p_97742_, Component p_97743_) {
