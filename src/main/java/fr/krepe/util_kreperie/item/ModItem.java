package fr.krepe.util_kreperie.item;
...
import fr.krepe.util_kreperie.item.armor.ModArmorItemLight;
import fr.krepe.util_kreperie.item.armor.ModArmorItemLead;
import fr.krepe.util_kreperie.item.armor.ModArmorItemScuba;
import fr.krepe.util_kreperie.item.custom.OreCollector;
...
public class ModItem {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Util_Kreperie.MOD_ID);
