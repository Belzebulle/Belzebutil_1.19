...
public class EnergyBlockMenu extends AbstractContainerMenu {
    ...
    public EnergyBlockMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }
    public EnergyBlockMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ENERGY_BLOCK_MENU.get(), pContainerId);

        checkContainerSize(inv, 0);
        blockEntity = ((EnergyBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ENERGY_BLOCK.get());
    }
